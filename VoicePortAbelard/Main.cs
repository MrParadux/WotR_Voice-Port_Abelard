...
public static class Main {
    ...
    public static class Soundbanks {
        ...
        const string PreviewName = "VoicePortAbelard_Test";
        ...
        {
            LocalizationManager.CurrentPack.PutString("VoicePortAbelard", "Abelard");

            var blueprint = new BlueprintUnitAsksList
            {
                // Every mod requires its own unique GUID. Autogenerated on template creation.
                AssetGuid = new(System.Guid.Parse("2d51adce680c49d7836069a918576842")),
                name = "VoicePortAbelard_Barks",
                DisplayName = new() { m_Key = "VoicePortAbelard" }
            };
                ...
                new UnitAsksComponent()
            {
                ...
                SoundBanks = [ "VoicePortAbelard_GVR_ENG" ],
                ...
                PreviewSound = "VoicePortAbelard_Test",
                Aggro = new()
                {
                    Entries =
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CombatStart_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CombatStart_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CombatStart_03",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Fatigue = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Fatigue",
                            RandomWeight = 0.0f,
                            ExcludeTime = 0,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Death = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Death",
                            RandomWeight = 0.0f,
                            ExcludeTime = 0,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Unconscious = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Unconscious",
                            RandomWeight = 0.0f,
                            ExcludeTime = 0,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                LowHealth = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_LowHealth_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_LowHealth_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                CriticalHit = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CharCrit_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CharCrit_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CharCrit_03",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Order = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_AttackOrder_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 3,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_AttackOrder_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 3,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_AttackOrder_03",
                            RandomWeight = 0.0f,
                            ExcludeTime = 3,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_AttackOrder_04",
                            RandomWeight = 0.0f,
                            ExcludeTime = 3,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                OrderMove = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_03",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_04",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_05",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_06",
                            RandomWeight = 0.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Move_07",
                            RandomWeight = 0.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Selected = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_01",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_02",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_03",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_04",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_05",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Select_06",
                            RandomWeight = 1.0f,
                            ExcludeTime = 4,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_SelectJoke",
                            RandomWeight = 0.1f,
                            ExcludeTime = 30,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                RefuseEquip = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CantEquip_01",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CantEquip_02",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                RefuseCast = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CantCast",
                            RandomWeight = 0.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                CheckSuccess = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CheckSuccess_01",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CheckSuccess_02",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                CheckFail = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CheckFail_01",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_CheckFail_02",
                            RandomWeight = 1.0f,
                            ExcludeTime = 2,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Discovery = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Discovery_01",
                            RandomWeight = 0.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_Discovery_02",
                            RandomWeight = 0.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                Stealth = new()
                {
                    ...
                    [
                        ...
                        {
                            Text = null,
                            AkEvent = "VoicePortAbelard_StealthMode",
                            RandomWeight = 1.0f,
                            ExcludeTime = 1,
                            m_RequiredFlags = [],
                            m_ExcludedFlags = [],
                ...
                [
                    new()
                    {
                        ...
                        [
                            ...
                            {
                                Text = null,
                                AkEvent = "VoicePortAbelard_AttackShort",
                                RandomWeight = 0.0f,
                                ExcludeTime = 0,
                                m_RequiredFlags = [],
                                m_ExcludedFlags = [],
                    ...
                    new()
                    {
                        ...
                        [
                            ...
                            {
                                Text = null,
                                AkEvent = "VoicePortAbelard_CoupDeGrace",
                                RandomWeight = 0.0f,
                                ExcludeTime = 0,
                                m_RequiredFlags = [],
                                m_ExcludedFlags = [],
